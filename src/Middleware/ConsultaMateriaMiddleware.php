...
class ConsultaMateriaMiddleware
{
    /**
    ...
    public function __invoke(Request $request, RequestHandler $handler): Response
    {
        ...
        if ($usuarioEncontrado[0]->tipo_id == 1 || $usuarioEncontrado[0]->tipo_id == 2 || $usuarioEncontrado[0]->tipo_id == 3
        && $usuarioEncontrado != [])
        {
        ...
        }else
        {
            ...
            $response->getBody()->write("Token ingresado no valido.");
